...
#define e0_driver_type TMC2208  //For the E driver. See below for your driver type and replace change_value with it.
#endif
...
#define INVERT_Z_DIR true // This defines the direction of travel for your Z axis. Change to false if direction is wrong
...
#define Total_filament_path 200 // Please measure the entire distance fron the Extruder to the the tip of the nozzle as accurately as possible. Replace change_value with your measured value here in mm units. NOT ft/inch.
...
#define CUSTOM_MACHINE_NAME "Big Boy"
...
#else
#define Z_MIN_PROBE_ENDSTOP_INVERTING true //default logic set up for non ABL set up
